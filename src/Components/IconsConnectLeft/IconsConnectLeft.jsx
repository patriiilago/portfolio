import "./IconsConnectLeft.css"
import whatsapp from "./../../assets/whatsapp.png"
import git from "./../../assets/git.png"
import linkedin from "./../../assets/linkedin.png"

const IconsConnectLeft = () => {
    return (
        <section className="iconsConnectLeft">
            ...
            <div className="connectVerticalLine"></div>
        </section>
    );
};

export default IconsConnectLeft;
